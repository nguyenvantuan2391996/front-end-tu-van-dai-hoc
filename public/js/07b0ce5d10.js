    ...
    try {
        if (window.FontAwesomeCdnConfig) {
            var j = window.FontAwesomeCdnConfig,
                ...
                q = d.bind(d, "fa"),
                r = function() {};
            j.autoA11y.enabled && (a(q), c(q)), j.reporting.enabled && b(j.reporting.domains, location.host) && i.load(l + "https://cdnjs.cloudflare.com/ajax/libs/stats.js/r17/Stats.js"), cssUrl = "https://" + k + "/" + m + ".css", new f(n).load(p).then(function() {
